  ...
  return (
    <div>
      <div className="grid grid-cols-2 space-x-0 justify my-5">
        {/* left card */}
        <div className="h-[32em] w-[36em] border-2 border-lime-200 rounded-[1.5em] bg-gradient-to-br from-lime-100 to-lime200 text-black font-nunito p-[1em] flex justify-center items-left flex-col gap-[0.75em] backdrop-blur-[12px] ">
        ...
        <div className="w-800 h-[50rem] shadow-[15px_15px_30px_rgb(25,25,25),-15px_-15px_30px_rgb(60,60,60)] rounded-[30px] bg-lime-800 flex flex-col justify-between">
