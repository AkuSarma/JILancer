  ...
  return (
    <div>
      <div className="grid grid-cols-2 gap-1">
        {/* left card */}
        <div className="h-[16em] w-[18em] border-2 border-lime-200 rounded-[1.5em] bg-gradient-to-br from-lime-100 to-lime200 text-black font-nunito p-[1em] flex justify-center items-left flex-col gap-[0.75em] backdrop-blur-[12px] my-5">
        ...
        <div className="w-800 h-[32rem] row-span-2 mt-5 mb-5 mr-5 shadow-[15px_15px_30px_rgb(25,25,25),-15px_-15px_30px_rgb(60,60,60)] rounded-[30px] bg-lime-800 flex flex-col justify-between">
